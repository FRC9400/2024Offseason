...
public class AutoConstants {
    ...
    public static double BlueDegR = 23;

    public static double BlueVelL = 70;
    public static double BlueRatioL = 0.5;
    public static double BlueDegL = 27;

    public static double RedVelL = 70;
    public static double RedRatioL = 0.7;
    public static double RedAngleL = 25;

    public static double RedVelR = 70;
    public static double RedRatioR = 0.7;
    public static double RedAngleR = 25;

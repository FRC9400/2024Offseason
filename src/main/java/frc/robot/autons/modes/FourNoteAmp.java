...
public class FourNoteAmp extends SequentialCommandGroup {
    ...
    public FourNoteAmp(Swerve swerve, Superstructure superstructure){
        ...
        addCommands(
            ...
            new WaitCommand(2),
            swerve.runChoreoTrajStandard(Choreo.getTrajectory("4NoteAmpA")),
            new InstantCommand(() -> superstructure.requestPreShoot()),
            new WaitCommand(2),
            swerve.runChoreoTrajStandard(Choreo.getTrajectory("4NoteAmpB")),
            new InstantCommand(() -> superstructure.requestIntake()),
            new WaitCommand(2),
            swerve.runChoreoTrajStandard(Choreo.getTrajectory("4NoteAmpC")),
            new InstantCommand(() -> superstructure.requestPreShoot()),
            new WaitCommand(2),
            swerve.runChoreoTrajStandard(Choreo.getTrajectory("4NoteAmpD")),
            new InstantCommand(() -> superstructure.requestIntake()),
            new WaitCommand(2),
            swerve.runChoreoTrajStandard(Choreo.getTrajectory("4NoteAmpE")),
            new InstantCommand(() -> superstructure.requestPreShoot())
        );
    }

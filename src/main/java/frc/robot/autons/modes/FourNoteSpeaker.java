...
public class FourNoteSpeaker extends SequentialCommandGroup {
    ...
    public FourNoteSpeaker(Swerve swerve, Superstructure superstructure){
        ...
        addCommands(
            ...
            new WaitCommand(2),
            swerve.runChoreoTrajStandard(Choreo.getTrajectory("4NoteSpeakerA")),
            new InstantCommand(() -> superstructure.requestIntake()),
            new WaitCommand(2),
            swerve.runChoreoTrajStandard(Choreo.getTrajectory("4NoteSpeakerB")),
            new InstantCommand(() -> superstructure.requestPreShoot()),
            new WaitCommand(2),
            swerve.runChoreoTrajStandard(Choreo.getTrajectory("4NoteSpeakerC")),
            new InstantCommand(() -> superstructure.requestIntake()),
            new WaitCommand(2),
            swerve.runChoreoTrajStandard(Choreo.getTrajectory("4NoteSpeakerD")),
            new InstantCommand(() -> superstructure.requestPreShoot()),
            new WaitCommand(2),
            swerve.runChoreoTrajStandard(Choreo.getTrajectory("4NoteSpeakerE")),
            new InstantCommand(() -> superstructure.requestIntake()),
            new WaitCommand(2),
            swerve.runChoreoTrajStandard(Choreo.getTrajectory("4NoteSpeakerF")),
            new InstantCommand(() -> superstructure.requestPreShoot())
        );
    }

 ...
 * Modified version of WPILib's InterpolatingTreeMap FROM FRC 8033
 */
public class InterpolatingShotTree {
  ...
  private ShotData interpolate(ShotData startValue, ShotData endValue, double t) {
    return new ShotData(
        ...
        MathUtil.interpolate(startValue.velocity(), endValue.velocity(), t),
        MathUtil.interpolate(startValue.ratio(), endValue.ratio(), t),
        MathUtil.interpolate(

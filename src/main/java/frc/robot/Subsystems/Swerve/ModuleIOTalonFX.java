...
public class ModuleIOTalonFX implements ModuleIO{
    ...
    public void setTurnAngle(double angleDeg) {
        steerRequest.Position = Conversions.DegreesToRotations(angleDeg, swerveConstants.moduleConstants.steerGearRatio);
    ...
    public void resetToAbsolute() {
        ...
        double absolutePositionRotations_1 = Conversions.DegreesToRotations(absolutePositionDegrees_1, swerveConstants.moduleConstants.steerGearRatio);
    ...
    public Rotation2d getAngle(){
        return new Rotation2d(Units.degreesToRadians(Conversions.RotationsToDegrees(steerMotor.getPosition().getValue(), swerveConstants.moduleConstants.steerGearRatio)));
    }
